...
#' @seealso \code{\link{maxent}}, \code{\link{gm}}, \code{\link{fisher0}}
...
#' @export
rgm <-function(Xb=as.matrix(Env2[,-c(1,2)]),sp=sp_pteridium_aquilinum,iter=500,gamma=-0.5,tau="default",mul=0.1){
